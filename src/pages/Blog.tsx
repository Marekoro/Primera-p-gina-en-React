...
function Blog() {
    ...
    <div className="pl-6 pt-6 whitespace-pre-line">
        ...
        <div className="grid grid-cols-3 p-8" key={index}>
          ...
          <div className="col-span-2 bg-teal-400 rounded-br-lg h-[5vh] border-r-4 border-b-4 border-indigo-500 border-double flex items-center justify-center outline-3 break-words">{"no se"}</div>
        </div>
